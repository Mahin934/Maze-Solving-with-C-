...
public:
    ...
    void about()
    {
        ...
        SetConsoleCursorPosition(GetStdHandle(STD_OUTPUT_HANDLE), COORD{ (short)OFFSET, (short)OFFSET + 10 });
...
int main()
{
   // system("COLOR F0");
    ...
    SetConsoleCursorPosition(GetStdHandle(STD_OUTPUT_HANDLE), COORD{ (short)OFFSET+22, (short)OFFSET });
    std::cout << "***WELCOME***";
    SetConsoleCursorPosition(GetStdHandle(STD_OUTPUT_HANDLE), COORD{ (short)OFFSET+9, (short)OFFSET+1 });
    std::cout << "Please Enter Your Name To Start  The Game";
    SetConsoleCursorPosition(GetStdHandle(STD_OUTPUT_HANDLE), COORD{ (short)OFFSET+3, (short)OFFSET + 2 });
    std::cout << "-----------------------------------------------------";
    SetConsoleCursorPosition(GetStdHandle(STD_OUTPUT_HANDLE), COORD{ (short)OFFSET, (short)OFFSET+4 });
    std::cout << "Player: ";
